...
<p><?php echo TrustindexTestimonialsPlugin::___("Add reviews from %s and other platforms to your website. %s review platforms to choose from. Create an account and make your first widget.", [ 'Google, Facebook, Trustpilot, Airbnb, Booking, Tripadvisor', "135" ]); ?></p>
</div>
</div>
</a>
</div>
